defmodule Droodotfoo.Wiki.Storage do
  @moduledoc """
  ...
  defp wiki_bucket do
    Application.get_env(:droodotfoo, __MODULE__)[:bucket_wiki] || "droo-wiki"
  end

  defp backups_bucket do
    Application.get_env(:droodotfoo, __MODULE__)[:bucket_backups] || "xochimilco-backups"
  end
end
