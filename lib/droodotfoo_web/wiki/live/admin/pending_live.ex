defmodule DroodotfooWeb.Wiki.Admin.PendingLive do
  @moduledoc """
    ...
    case Content.get_pending_edit(String.to_integer(id)) do
      nil ->
        {:noreply,
         ...
         |> push_navigate(to: "/admin/pending")}
  ...
  def handle_event("select", %{"id" => id}, socket) do
    {:noreply, push_patch(socket, to: "/admin/pending/#{id}")}
  end
  ...
  def handle_event("back", _params, socket) do
    {:noreply, push_patch(socket, to: "/admin/pending")}
  end
