defmodule DroodotfooWeb.DroodotfooLive do
  @moduledoc """
  Homepage LiveView for droo.foo portfolio website.
  Displays latest blog posts and social links.

  Note: Terminal functionality has been archived to .archived_terminal/
  """
